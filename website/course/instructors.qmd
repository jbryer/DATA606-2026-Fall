...
<img src='/images/christian_martinez.jpg' width='200' align='left' style = 'padding-right: 20px' />

**Christian Martinez**  
**Email:** [c.martinez0@outlook.com](mailto:c.martinez0@outlook.com)

I am an Adjunct Lecturer at the City University of New York and the Founder and Director of the [NYC Open Data Lab](https://nycopendatalab.org). My work centers on data science, reproducible research, open-source software, and helping people use public data more effectively. I created the [nycOpenData](https://docs.ropensci.org/nycOpenData/index.html) R package and an expanding ecosystem of OpenData packages that make government open data easier to access and analyze directly in R. My open-source and community work was recognized with the inaugural 2026 [Posit Impact Award](https://posit.co/blog/introducing-posit-impact-awards) in Open Source Contribution.
