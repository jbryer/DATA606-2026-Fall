...
author: Jason Bryer, Ph.D., Angela Lui, Ph.D., and Christian Martinez
date: "Fall 2026"
output:
...
knitr::include_graphics('images/BryerVan1.jpeg')
```

]
.pull-right[
```{r, out.width='100%', fig.align='center', echo=FALSE}
knitr::include_graphics('images/BryerVan2.jpeg')
```
...
.pull-left[
<img alt='Christian Martinez' src='images/christian_martinez.jpg' height='500' />
]
.pull-right[

* Adjunct Lecturer at the City University of New York
* Founder and Director of the NYC Open Data Lab. 
* My work centers on data science, reproducible research, open-source software, and helping people use public data more effectively. 
* Created the nycOpenData R package and an expanding ecosystem of OpenData packages that make government open data easier to access and analyze directly in R. 
* My open-source and community work was recognized with the inaugural 2026 Posit Impact Award in Open Source Contribution.

When I’m not doing any of this fun stuff, I’m on the handball court—always ready for a new challenger.
]
...
* Email: [jason.bryer@cuny.edu, angela.lui@cuny.edu, and c.martinez0@outlook.com](mailto:jason.bryer@cuny.edu;angela.lui@cuny.edu;c.martinez0@outlook.com?subject=DATA606)
...
[`r icons::fontawesome("paper-plane")` c.martinez0@outlook.com](mailto:c.martinez0@outlook.com)  
